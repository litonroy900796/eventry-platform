...
const eventSchema = z.object({
  ...
  ticketPrice: z.string().min(0, "Ticket price is required"),
...
export default function CreateEventForm() {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div className="space-y-1.5">
      ...
      <input type="number" name="ticketPrice" placeholder="0 = Free" min="0"
        className="w-full bg-[#27292F] border border-[#CCCCCC]/20 focus:border-indigo-500 focus:outline-none py-2.5 px-3 rounded-md text-white text-sm placeholder:text-[#555]" />
      {fieldErrors.ticketPrice && <p className="text-red-500 text-xs">{fieldErrors.ticketPrice}</p>}
    </div>
    <div className="space-y-1.5">
  ...
  <div className="space-y-1.5">
    ...
    <textarea name="details" rows={4} placeholder="Describe your event"
